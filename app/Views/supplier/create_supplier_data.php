...
<!-- title -->
<?= $this->section('title') ?>
<title>Tambah Supplier Data &mdash; myPOS</title>
<?= $this->endSection()?>
...
<div class="row">
    <div class="col-xl mt-3">
        <div class="card">
            <div class="card-header">
                <h1 class="card-title">Tambah Data Supplier</h1>
            </div>
            <div class="card-body">
                <form action="<?=site_url('supplier/save')?>" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control <?= ($validation->hasError('address')) ? 'is-invalid' : ''; ?>" rows="1" id="address" name="address" value="<?= old('address'); ?>"></textarea>
