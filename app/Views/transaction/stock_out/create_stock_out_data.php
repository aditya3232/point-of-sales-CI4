...
<div class="card-header">
    <div class="row">
        <div class="col-xl-6 text-left">
            <i class="align-middle mr-2" data-feather="shopping-cart"></i><span class="align-middle"><strong class="mr-2">Stock Out</strong>Barang Masuk / Pembelian</span>
        </div>
        <div class="col-xl-6 text-right">
            <a href="<?= site_url('stock/out'); ?>" class="btn btn-warning"><i class="align-middle mr-2" data-feather="arrow-left"></i>Back</a>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-xl mt-3">
        <div class="card">
            <div class="card-header">
                <h1 class="card-title">Tambah Stock Out</h1>
            </div>
            <div class="card-body">
                <form action="<?=site_url('stockout/save')?>" method="POST">
                    <?= csrf_field(); ?>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <!-- ketika di klik save maka setiap isi inputan akan disimpan oleh method save di controller -->
                    ...
                    <div class="mb-3">
                        <label class="form-label" for="detail">Info</label>
                        <input type="text" class="form-control" id="info" name="info" placeholder="rusak / hilang / kadaluwarsa / etc" required>
                    </div>
