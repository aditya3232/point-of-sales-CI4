...
<div class="row">
    <div class="col-xl mt-3">
        <div class="card">
            <div class="card-header">
                <h1 class="card-title">Tambah Data Items</h1>
            </div>
            <div class="card-body">
                <!-- form tambah data, tambahkan enctype supaya form bisa bekerja dengan inputan file -->
                <form action="<?=site_url('item/save')?>" method="POST" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?= ($validation->hasError('name_item')) ? 'is-invalid' : ''; ?>" id="name_item" name="name_item" value="<?= old('name_item'); ?>">
                    ...
                    <div class="mb-3 col-md-4">
                        ...
                        <select class="form-select <?= ($validation->hasError('unit_id')) ? 'is-invalid' : ''; ?>" id="Unit" name="unit_id">
                            ...
                            <option value="<?= $units['unit_id']; ?>"><?= $units['name']; ?></option>
                            <?php endForeach; ?>
                        </select>
