...
<!-- title -->
<?= $this->section('title') ?>
<title>Units Data &mdash; myPOS</title>
<?= $this->endSection()?>
...
<div class="card-header">
    <div class="row">
        ...
        <div class="col-xl-6 text-right">
            <a href="<?= site_url('unit/create') ?>" class="btn btn-success"><i class="align-middle mr-2" data-feather="plus"></i> Add New</a>
        </div>
    </div>
</div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-6 text-left">
                        <h1 class="card-title">Data Units</h1>
                    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="table-action text-right">
                            <form action="<?= site_url('unit/edit/'. $units['unit_id']) ?>" method="POST" class="d-inline" id="edit">
                                <?= csrf_field(); ?>
                            ...
                            <form action="<?= site_url('unit/delete/'. $units['unit_id']) ?>" method="POST" class="d-inline" id="GFG">
                                <?= csrf_field(); ?>
