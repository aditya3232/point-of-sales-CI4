...
class StockinModel extends Model
{
    ...
    // konfigurasi model
    protected $table = 'stock'; //nama tabel
    protected $primaryKey = 'stock_id';//primary key tabel


    protected $allowedFields = ['item_id', 'type', 'detail', 'supplier_id', 'qty', 'date'];//field yg boleh diisi secara manual
